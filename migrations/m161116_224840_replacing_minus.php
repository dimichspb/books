...
class m161116_224840_replacing_minus extends Migration
{
    public function up()
    {
        ...
        $this->renameTable('bx-book', 'bx_books');
    ...
    public function down()
    {
        ...
        $this->renameTable('bx_books', 'bx-book');
        $this->renameTable('bx_book_ratings', 'bx-book-ratings');

        $this->renameColumn('bx-users', 'User_ID', 'User-ID');

        $this->renameColumn('bx-book', 'Book_Title', 'Book-Title');
        $this->renameColumn('bx-book', 'Book_Author', 'Book-Author');
        $this->renameColumn('bx-book', 'Year_Of_Publication', 'Year-Of-Publication');
        $this->renameColumn('bx-book', 'Image_URL_S', 'Image-URL-S');
        $this->renameColumn('bx-book', 'Image_URL_M', 'Image-URL-M');
        $this->renameColumn('bx-book', 'Image_URL_L', 'Image-URL-L');
